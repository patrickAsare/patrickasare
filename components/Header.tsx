...
import avatarImage from "@/images/trooper.png";
...
const MobileNavigation: React.FC<React.ComponentProps<typeof Popover>> = (
  props
) => {
  return (
    <Popover {...props}>
...
const DesktopNavigation: React.FC<React.HTMLAttributes<HTMLElement>> = (
  props
) => {
  return (
    <nav {...props}>
  ...
  return (
    <>
      ...
      >
        ...
        <div ref={headerRef} className="top-0 z-10 h-16 pt-6" style={headerPos}>
          <Container
